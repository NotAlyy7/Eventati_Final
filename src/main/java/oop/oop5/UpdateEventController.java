...
{
    @FXML private ChoiceBox<Event> eventschoosecreate;
    ...
    public void initialize (URL arg0, ResourceBundle arg1)
    {
        ...
        Thread t = new Thread(() -> {
            ...
            Platform.runLater(() -> {
                ...
                eventschoosecreate.getItems().addAll(events);
    ...
    @FXML
    public void HandleUpdateEvent(ActionEvent event)
    {
        try
        {
            ...
            Category category = new Category(db.getEvents().get(id).getCategory().getCategoryID(),db.getEvents().get(id).getCategory().getCategoryName());
            Room room = roomChoiceBox.getValue();


            Organizer.updateEvent(id, name, description, date, time, price, category, room,db);
